The following Macro Script was adapted from the Strock (2021). 
  Strock, C. (2021, October). Protocol for extracting basic color metrics from Images in ImageJ/Fiji. https://doi.org/doi.org/10.5281/zenodo.5595203
